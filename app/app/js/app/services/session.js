angular.module('app.services').factory('session', function (serverConfig, $http, $q, iStorage, $rootScope) {
...
}).factory('facebook', function ($window, $q, $rootScope, iStorageMemory, stateAbbreviations,$facebook) {
  var FB, uid, friends = [];
  ...
  function loadProfile(params) {
	...
	$facebook.api(uid + '/?fields=email,first_name,last_name,picture,gender,address,birthday,link').then( 
	  function(fu) {
		var data = {
